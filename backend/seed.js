...
async function run() {
  ...
  const foods = await Food.insertMany([
      ...
      { name: 'Mực khô nướng', description: 'Mực khô nướng trên cồn, xé tơi, chấm tương ớt; vị ngọt, dai và thơm nồng.',
         image:"https://tse1.explicit.bing.net/th/id/OIP.qGxxgaleLqis8NQzUCRddAHaEH?rs=1&pid=ImgDetMain&o=7&rm=3", price: 89000, category: 'mon_nhau', isPromotion: true, promotionPrice: 69000, promotionEnd: promoEnd },
      { name: 'Trâu gác bếp', description: 'Thịt trâu hun khói dai, ngọt, thơm mùi mắc khén và hạt dỗi đặc trưng vùng cao.', 
        image: "https://th.bing.com/th/id/OIP.SkORPZQMbxCkS7bLqSGZ2QHaE8?w=291&h=194&c=7&r=0&o=7&dpr=1.3&pid=1.7&rm=3", price: 75000, category: 'mon_nhau' },
      { name: 'Bò lúc lắc', description: 'Bò Úc lúc lắc mềm ngọt, kèm rau sống',
         image: "https://th.bing.com/th/id/OIP.VhDtarX1a67uVeooY1akPAHaEK?w=306&h=180&c=7&r=0&o=7&dpr=1.3&pid=1.7&rm=3", price: 120000, category: 'mon_nhau', isPromotion: true, promotionPrice: 95000, promotionEnd: promoEnd },
      { name: 'Đậu hũ lướt ván', description: 'Đậu hũ tươi chiên vàng lớp vỏ nhưng bên trong vẫn mềm mịn như tan trong miệng.', 
        image: "https://th.bing.com/th/id/OIP.Wcpcj5xQ8m112uaK-yO97AHaEo?w=269&h=180&c=7&r=0&o=7&dpr=1.3&pid=1.7&rm=3", price: 95000, category: 'mon_nhau' },

      // Trà sữa
      { name: 'Trà sữa trân châu đường đen', description: 'Trà sữa thơm béo, trân châu đường đen Q dẻo',
         image: "https://th.bing.com/th/id/OIP.V1x45a263htiSm8-e2geyAHaEo?w=312&h=180&c=7&r=0&o=7&dpr=1.3&pid=1.7&rm=3", price: 35000, category: 'nuoc_uong', isPromotion: true, promotionPrice: 25000, promotionEnd: promoEnd },
      { name: 'Matcha Latte', description: 'một loại thức uống hiện đại kết hợp giữa tinh hoa trà đạo Nhật Bản và phong cách cà phê Ý (Latte).',
         image: "https://th.bing.com/th/id/OIP.hWdT_h74LiDWZPE1U7j7NwHaE8?w=265&h=180&c=7&r=0&o=7&dpr=1.3&pid=1.7&rm=3", price: 40000, category: 'nuoc_uong' },
      { name: 'Trà đào cam sả', description: 'Trà đào thơm mát, cam tươi và sả thư giãn',
         image: "https://th.bing.com/th/id/OIP.LyJHURwCCeZWpoxt6gU5XAHaFy?w=304&h=189&c=7&r=0&o=7&dpr=1.3&pid=1.7&rm=3", price: 30000, category: 'nuoc_uong' },
      { name: 'Trà sữa oolong', description: 'Trà oolong rang lửa, vị đậm đà béo ngọt',
         image: "https://phache.com.vn/upload/gallery/cach-lam-tra-sua-olong-ngon.jpg", price: 38000, category: 'nuoc_uong' },

      // Chiên
      { name: 'Khoai tây chiên', description: 'Khoai tây chiên giòn, kèm tương cà và phô mai',
        image:"https://th.bing.com/th/id/OIP.mipkfWqCLJT21YzFT1h3FwHaEL?w=279&h=180&c=7&r=0&o=7&dpr=1.3&pid=1.7&rm=3", price: 25000, category: 'an_vat' },
      { name: 'Bánh gối', description: 'Bánh gối nhân thịt, giòn tan thơm lừng',
        image:"https://th.bing.com/th/id/OIP.lr43C7hFzI2Fi1eSzEbBZgHaEK?w=293&h=180&c=7&r=0&o=7&dpr=1.3&pid=1.7&rm=3" ,price: 20000, category: 'an_vat' },
      { name: 'Nem rán', description: 'Nem rán truyền thống, nhân thịt và rau', 
        image:"https://th.bing.com/th/id/OIP.SuQcy1KKwUgGAHNzbs6iRwHaE8?w=254&h=180&c=7&r=0&o=7&dpr=1.3&pid=1.7&rm=3",price: 30000, category: 'an_vat', isPromotion: true, promotionPrice: 22000, promotionEnd: promoEnd },
      { name: 'Cá viên chiên', description: 'Cá viên chiên giòn, chấm tương ớt', 
        image:"https://th.bing.com/th/id/OIP.SuQcy1KKwUgGAHNzbs6iRwHaE8?w=254&h=180&c=7&r=0&o=7&dpr=1.3&pid=1.7&rm=3",price: 25000, category: 'an_vat' },
      {name:"Bánh xào",description:"Bánh xèo giòn rụm, nhân tôm thịt, ăn kèm rau sống và nước mắm chua ngọt",
        image:"https://www.tastingtable.com/img/gallery/bnh-xo-the-delectable-vietnamese-crepes-you-should-know/l-intro-1666117324.jpg",price:100000 , category:'an_vat'},

      // Pho bun
      { name: 'Phở bò tái', description: 'Phở bò tái nạm gầu, nước dùng hầm xương 12 tiếng',
        image:"https://th.bing.com/th/id/OIP.xgyeyD_eRNAYY9rpSiZCsQHaFs?w=233&h=180&c=7&r=0&o=7&dpr=1.3&pid=1.7&rm=3", price: 45000, category: 'bun_pho' },
      { name: 'Bún bò Huế', description: 'Bún bò Huế cay nồng, đầy đủ topping',
        image:"https://th.bing.com/th/id/OIP.95l_pa6ZQHAv2KnGRKnBDgHaEK?w=315&h=180&c=7&r=0&o=7&dpr=1.3&pid=1.7&rm=3", price: 50000, category: 'bun_pho', isPromotion: true, promotionPrice: 39000, promotionEnd: promoEnd },
      { name: 'Bún riêu cua', description: 'Bún riêu cua đồng nấu cà chua, đậu hũ chiên',
        image:"https://th.bing.com/th/id/OIP.J5gxVRwVObP0ewln1yC7ngHaEo?w=257&h=180&c=7&r=0&o=7&dpr=1.3&pid=1.7&rm=3", price: 40000, category: 'bun_pho' },
      { name: 'Phở gà', description: 'Phở gà ta thả vườn, nước trong vị ngọt thanh',
         image:"https://th.bing.com/th/id/OIP.RqUryq78mhTBbYt5YRvavgHaE8?w=254&h=180&c=7&r=0&o=7&dpr=1.3&pid=1.7&rm=3",price: 42000, category: 'bun_pho' },
      {name:'Bún Đậu Mắm Tôm', description: 'Bún đậu mắm tôm đặc sản Hà Nội, đậu hũ chiên giòn, chấm mắm tôm pha chua cay',
        image:"https://th.bing.com/th/id/OIP.2qW-Zi6pOV1zsWppjY50OQHaD3?w=342&h=180&c=7&r=0&o=7&dpr=1.3&pid=1.7&rm=3",price:100000, category:'bun_pho'},
      ...
      { name: 'Bánh tráng trộn', description: 'Bánh tráng trộn sate, khô bò, trứng cút', 
        image:"https://th.bing.com/th/id/OIP.uYERNiVT5sDQ30mVgybiIgHaEc?w=277&h=180&c=7&r=0&o=7&dpr=1.3&pid=1.7&rm=3",price: 20000, category: 'an_vat' },
      { name: 'Xiên que', description: 'Xiên que đủ loại nướng sốt cay', 
        image:"https://th.bing.com/th/id/OIP.RsQx3NzbYDMk_VArxnQsMwHaGr?w=192&h=180&c=7&r=0&o=7&dpr=1.3&pid=1.7&rm=3",price: 15000, category: 'an_vat' },
      { name: 'Tokbokki', description: 'Bánh gạo Hàn Quốc sốt cay ngọt',
        image:"https://th.bing.com/th/id/OIP.7ZQR15V46d3tPPpdOqRPZQHaFT?w=227&h=180&c=7&r=0&o=7&dpr=1.3&pid=1.7&rm=3", price: 35000, category: 'an_vat', isPromotion: true, promotionPrice: 25000, promotionEnd: promoEnd },
      { name: 'Takoyaki', description: 'Bánh bạch tuộc kiểu Nhật, 6 viên',
        image:"https://th.bing.com/th/id/OIP.VSTd2UlKdt3UPQH7S-jAnQHaE8?w=272&h=181&c=7&r=0&o=7&dpr=1.3&pid=1.7&rm=3" ,price: 30000, category: 'an_vat' },

      // Nuoc
      { name: 'Nước cam ép', description: 'Cam tươi ép nguyên chất, giàu vitamin C',
        image:"https://tse1.explicit.bing.net/th/id/OIP.pj-aBXUgEdFb4KHJ_rtbIwHaFy?rs=1&pid=ImgDetMain&o=7&rm=3", price: 25000, category: 'nuoc_uong' },
      { name: 'Sinh tố bơ', description: 'Bơ sáp dẻo béo, thêm sữa đặc',
        image:"https://th.bing.com/th/id/OIP.G1B5goGoAYdYfmOIdeYPrgHaE8?w=283&h=189&c=7&r=0&o=7&dpr=1.3&pid=1.7&rm=3", price: 30000, category: 'nuoc_uong' },
      { name: 'Coca Cola', description: 'Coca Cola lon 330ml mát lạnh',
        image:"https://th.bing.com/th/id/OIP.oil-osvsyJqUwJAphtn_wQHaKe?w=128&h=181&c=7&r=0&o=7&dpr=1.3&pid=1.7&rm=3", price: 15000, category: 'nuoc_uong' },
      { name: 'Nước chanh dây', description: 'Chanh dây tươi, ngọt chua sảng khoái', 
        image:"https://th.bing.com/th/id/OIP.7HmXB8r3Be6LJUIEUV3TOwHaE8?w=253&h=180&c=7&r=0&o=7&dpr=1.3&pid=1.7&rm=3",price: 20000, category: 'nuoc_uong' },
